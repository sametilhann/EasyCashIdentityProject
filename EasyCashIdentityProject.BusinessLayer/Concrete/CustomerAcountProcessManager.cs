...
{
    public class CustomerAcountProcessManager : ICustomerAccountProcessService
    {

        private readonly ICustomerAccountProcessDal _customerAccountProcessDal;

        public CustomerAcountProcessManager(ICustomerAccountProcessDal customerAccountProcessDal)
        {
